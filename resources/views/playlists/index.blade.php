                ...
                @foreach($playlists as $playlist)
                    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl shadow-lg text-white p-6 flex flex-col justify-between hover:shadow-2xl transition-shadow duration-300">
                        ...
                        <div class="mt-6 flex space-x-3">
                            <a href="{{ route('playlists.show', $playlist->id) }}" target="_blank" class="flex-1 bg-green-500 hover:bg-green-600 rounded-lg py-2 text-center font-semibold shadow-md transition-colors">
                                Reproduzir
                            </a>
